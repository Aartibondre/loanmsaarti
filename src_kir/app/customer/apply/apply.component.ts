...
export class ApplyComponent implements OnInit {
  ...
  resetForm(form?:NgForm) {
    if(form!=null)
    {
      ...
      this.cusServ.ppData={BorrowerId:0,FirstName:'',LastName:'',Contact:'',Dob:'',Gender:'',Occupation:'',IdentityType:'',IdentityId:'', Address:'',City:'',State:'',ZipCode:''};
      this.propSrv.ppData={ApplicationId:0,LoanType:'',LoanPurpose:'',LoanTenure:0,RequestAmount:0};
      this.objLegal.ppData={ApplicationNo:0,PropertyProof:'',BankSalarySlip:'',AddressProof:'',GuarantorName:'',GuarantorProofType:'',GuarantorProofId:''};
    }
  }
  onSubmit(form1:NgForm)
  {
    console.log(this.cusServ.ppData);
